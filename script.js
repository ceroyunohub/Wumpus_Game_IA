...
window.onload = function()
{
	...
	mundosWumpus = [
		{
			dimensiones: 6,
            posAvismos: [[getRandomArbitrary(1, 3), getRandomArbitrary(1, 3)], [getRandomArbitrary(1, 3), getRandomArbitrary(1, 3)], [getRandomArbitrary(1, 3), getRandomArbitrary(1, 3)], [getRandomArbitrary(1, 3), getRandomArbitrary(1, 3)], [getRandomArbitrary(1, 3), getRandomArbitrary(1, 3)]],
            posWumpus: [[getRandomArbitrary(3, 4), getRandomArbitrary(3, 4)]],
            posOro: [[getRandomArbitrary(4, 5), getRandomArbitrary(4, 5)]], 
			posAventurero: [0,0], 
			tiempo : 12000, 
			vidas : 100
		}
	...
	function movimientoPersonaje()
    {
		...
		*/
		...
		else
		{
			...
			{
                //disparaFlecha(posPersonaje[0], posPersonaje[1]);
			}
		}
	}
    ...
    function disparaFlecha(fila, columna)
	{
